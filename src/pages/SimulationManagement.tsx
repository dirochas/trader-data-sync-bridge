  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Simulation Management</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="tech-card tech-card-hover card-blue">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-foreground">Total Simulations</CardTitle>
          ...
          <Card className="tech-card tech-card-hover card-green">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-foreground">Avg Account Size</CardTitle>
          ...
          <Card className="tech-card tech-card-hover card-purple">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-foreground">Avg ROI</CardTitle>
        ...
        {filteredSimulations.length === 0 ? (
          <Card className="tech-card">
            <CardContent className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-foreground">No simulations found</h3>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <p className="font-semibold text-foreground">{formatCurrency(simulation.account_size)}</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Test Cost</p>
                      <p className="font-semibold text-foreground">{formatCurrency(simulation.test_cost)}</p>
                    </div>
                    <div>
